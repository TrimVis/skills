...
From the `ste-writing` skill by Ege Chelebi ([@woosal1337](https://github.com/woosal1337)),
published with the video series episode "The Cure for AI Slop":
https://github.com/woosal1337/blog/blob/main/videos/ep01-the-cure-for-ai-slop/ste-writing-skill.md

Synced verbatim on 2026-08-14, except for the lint paths in `## Verify`, which
point at the installed skill directory. `ste-lint.py` and
`ste-recurring-errors.md` come from the same upstream directory. Check upstream
for newer versions before you edit this file.
